            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form autocomplete="off" method="POST" class="needs-validation updateOrder-form"
                        ...
                        action="<?php echo e(route('admin.departments.range.store', ['slug' => $department->slug])); ?>" novalidate>
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="col-lg-6">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <select class="form-control select2" id="from-type-input"
                                                value="<?php echo e(old('from_type')); ?>" required name="from_type">
                                        ...
                                        <div class="col-lg-8">
                                            <select class="form-control" id="delivery-from-input"
                                                value="<?php echo e(old('delivery_from')); ?>" required name="delivery_from">
                                                <option value="">Select</option>
                                            </select>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <select class="form-control select2" id="to-type-input"
                                                value="<?php echo e(old('to_type')); ?>" required name="to_type">
                                                <option value="">Select</option>
                                                <option value="department">Department</option>
                                                <option value="knitting">Knitting House</option>
                                                <option value="dyeing">Dyeing House</option>
                                        ...
                                        <div class="col-lg-8">
                                            <select class="form-control" id="delivery-to-input"
                                                value="<?php echo e(old('deliver_to')); ?>" required name="deliver_to">
                                                <option value="">Select</option>
                                            </select>
...
<?php echo $__env->make('layouts.departments.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\shafi_portal\resources\views/admin/department/orders/index.blade.php ENDPATH**/ ?>