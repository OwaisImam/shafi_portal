            ...
            <div class="card">
                <div class="card-body">
                    <form class="needs-validation" novalidate enctype="multipart/form-data" method="POST"
                        action="<?php echo e(route('admin.email_templates.update', $emailTemplate->id)); ?>">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="validationCustom01" placeholder="Name"
                                        value="<?php echo e($emailTemplate->getName()); ?>" required name="name">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="subject" placeholder="Subject"
                                        value="<?php echo e($emailTemplate->getSubject()); ?>" required name="subject">
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                    <div class="invalid-feedback">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea id="content" name="content"><?php echo e($emailTemplate->getContent()); ?></textarea>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                    <div class="invalid-feedback">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" value="<?php echo e($emailTemplate->getKey()); ?>"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/owaisimam/PhpStormProjects/shafi_portal/resources/views/admin/email_template/edit.blade.php ENDPATH**/ ?>