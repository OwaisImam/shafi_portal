...
<script>
    $('#change-password').on('submit', function(event) {
        ...
        $.ajax({
            url: "<?php echo e(url('client/update-password')); ?>" + "/" + Id,
            type: "POST",
            data: {
            ...
            success: function(response) {
                ...
                if (response.isSuccess == false) {
                    ...
                    setTimeout(function() {
                        window.location.href = "<?php echo e(route('client.home')); ?>";
                    }, 1000);
                }
            },
...
<?php /**PATH /Users/owaisimam/PhpStormProjects/shafi_portal/resources/views/layouts/departments/vendor-scripts.blade.php ENDPATH**/ ?>