...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'Slow Jobs','title' => 'Time: '.e(number_format($time, 0)).'ms; Run at: '.e($runAt).';','details' => ''.e(is_array($config['threshold']) ? '' : $config['threshold'].'ms threshold, ').'past '.e($this->periodForHumans()).'']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'pulse::components.icons.command-line','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php /**PATH /Users/owaisimam/PhpStormProjects/shafi_portal/vendor/laravel/pulse/src/../resources/views/livewire/slow-jobs.blade.php ENDPATH**/ ?>