                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="avatar-md profile-user-wid mb-4">
                                <img src="<?php echo e(isset($user->profilePicture) ? asset($user->profilePicture->image_path) : asset('build/images/users/avatar-1.jpg')); ?>"
                                    alt="" class="img-thumbnail rounded-circle">
                            </div>
                            <h5 class="font-size-15 text-truncate"><?php echo e($user->name); ?></h5>
                        ...
                        <table class="table table-nowrap mb-0">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e($user->city?->state?->country?->name . ' ,' . $user->address); ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                        ...
                        <ul class="verti-timeline list-unstyled">
                            ...
                            <li class="event-list">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1">
                                        <div>
                                            <h5 class="font-size-15"><a href="javascript: void(0);" class="text-dark">UI /UX
                                                    Designer</a></h5>
...
unset($__errorArgs, $__bag); ?>"
                                id="useremail" value="<?php echo e($user->email); ?>" name="email" placeholder="Enter email"
                                autofocus>
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    value="<?php echo e(date('d-m-Y', strtotime($user->dob))); ?>" data-provide="datepicker"
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            <div class="text-start mt-2">
                                <img src="<?php echo e(asset($user->profilePicture?->file_path)); ?>" alt=""
                        ...
                        <div class="mt-3 d-grid">
                            <button class="btn btn-primary waves-effect waves-light UpdateProfile"
                                data-id="<?php echo e($user->id); ?>" type="submit">Update</button>
                        </div>
                    </form>
                </div>
            </div><!-- /.modal-content -->
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/owaisimam/PhpStormProjects/shafi_portal/resources/views/admin/users/profile.blade.php ENDPATH**/ ?>