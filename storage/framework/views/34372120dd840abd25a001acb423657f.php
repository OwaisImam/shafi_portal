...
<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('components.breadcrumb'); ?>
        ...
        <?php $__env->slot('title'); ?>
            <?php echo e($department->name); ?> Dashboard
        <?php $__env->endSlot(); ?>
                    ...
                    <div class="row">
                        <div class="col-7">
                            <div class="text-primary p-3">
                                ...
                                <p><?php echo e(env('APP_NAME')); ?> <?php echo e($department->name); ?> Dashboard</p>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="avatar-md profile-user-wid mb-4">
                                <img src="<?php echo e(isset(Auth::guard('web')->user()->avatar) ? asset(Auth::guard('web')->user()->avatar) : asset('build/images/users/avatar-1.jpg')); ?>"
                                    alt="" class="img-thumbnail rounded-circle">
                            </div>
                            <h5 class="font-size-15 text-truncate"><?php echo e(Str::ucfirst(Auth::guard('web')->user()->name)); ?>
...
<?php echo $__env->make('layouts.departments.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/owaisimam/PhpStormProjects/shafi_portal/resources/views/admin/department/dashboard.blade.php ENDPATH**/ ?>