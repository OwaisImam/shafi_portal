...
<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('components.breadcrumb'); ?>
        ...
        <?php $__env->slot('title'); ?>
            <?php echo app('translator')->get('translation.YarnProgram'); ?>
        <?php $__env->endSlot(); ?>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('orders-create')): ?>
                            <div class="col-sm-8">
                                <div class="text-sm-end">
                                    <a href="<?php echo e(route('admin.departments.yarn_program.create', ['slug' => $department->slug])); ?>"
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(URL::asset('build/js/pages/orders/yarn_program-list.init.js')); ?>"></script>
...
<?php echo $__env->make('layouts.departments.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/owaisimam/PhpStormProjects/shafi_portal/resources/views/admin/department/yarn_program/index.blade.php ENDPATH**/ ?>