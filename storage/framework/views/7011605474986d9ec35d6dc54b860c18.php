...
<?php $__env->startSection('content'); ?>
    ...
    <!-- removeKnittingProgramModal -->
    <div class="modal fade" id="removeKnittingProgramModal" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-content">
                <div class="modal-body px-4 py-5 text-center">
                    ...
                    <div class="hstack gap-2 justify-content-center mb-0">
                        <button type="button" class="btn btn-danger" id="remove-knitting-program">Remove Now</button>
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(URL::asset('build/js/pages/knitting_program/knitting_program-list.init.js')); ?>"></script>
...
<?php echo $__env->make('layouts.departments.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\shafi_portal\resources\views/admin/department/knitting_program/index.blade.php ENDPATH**/ ?>