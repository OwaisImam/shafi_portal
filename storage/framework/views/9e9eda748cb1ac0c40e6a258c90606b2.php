            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form autocomplete="off" method="POST" class="needs-validation createAgent-form"
                        ...
                        action="<?php echo e(route('admin.departments.agents.store', ['slug' => $department->slug])); ?>" novalidate>
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="col-lg-12">
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(URL::asset('build/js/pages/agents/agents-list.init.js')); ?>"></script>
