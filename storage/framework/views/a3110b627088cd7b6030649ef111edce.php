...
<?php foreach($attributes->onlyProps(['cols' => 12, 'fullWidth' => false]) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
<?php $attributes = $attributes->exceptProps(['cols' => 12, 'fullWidth' => false]); ?>
<?php foreach (array_filter((['cols' => 12, 'fullWidth' => false]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-3698869220-0', $__slots ?? [], get_defined_vars());
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'pulse::components.theme-switcher','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php /**PATH /Users/owaisimam/PhpStormProjects/shafi_portal/vendor/laravel/pulse/src/../resources/views/components/pulse.blade.php ENDPATH**/ ?>