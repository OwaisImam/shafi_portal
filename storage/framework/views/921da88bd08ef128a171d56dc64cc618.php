...
<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('components.breadcrumb'); ?>
        ...
        <?php $__env->slot('title'); ?>
            <?php echo app('translator')->get('translation.Knitting'); ?>
        <?php $__env->endSlot(); ?>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-8">
                            <div class="text-sm-end">
                                <button type="button" data-bs-toggle="modal" data-bs-target="#newKnittingModal"
                                    class="btn btn-success btn-rounded waves-effect waves-light addKnitting-modal mb-2"><i
                                        class="mdi mdi-plus me-1"></i> Add Knitting</button>
                            </div>
                        </div><!-- end col-->
                    </div>
                    <!-- end row -->
    ...
    <!-- Modal -->
    <div class="modal fade" id="newKnittingModal" tabindex="-1" aria-labelledby="newKnittingModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="newKnittingModalLabel">Add Knitting</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form autocomplete="off" method="POST" class="needs-validation createKnitting-form"
                        enctype="multipart/form-data" id="createKnitting-form"
                        action="<?php echo e(route('admin.departments.knitting.store', ['slug' => $department->slug])); ?>" novalidate>
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="col-lg-6">
                                <input type="hidden" class="form-control" id="knittingId-input">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="company_name" id="company-name-input" class="form-control"
                                        placeholder="Enter name" value="<?php echo e(old('company_name')); ?>" required />
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="contact_person" id="contact-person-input"
                                        class="form-control" value="<?php echo e(old('contact_person')); ?>"
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="contact" id="contact-number-input"
                                        ...
                                        value="<?php echo e(old('contact')); ?> " data-inputmask="'mask': '999999999999'" />
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" name="address" id="address-input"><?php echo e(old('address')); ?></textarea>
                        ...
                        <div class="col-lg-12">
                            <div class="text-end">
                                ...
                                <button type="submit" id="addKnitting-btn" class="btn btn-success">Add
                                    Knitting</button>
                            </div>
                        </div>
                </div>
    ...
    <!-- removeItemModal -->
    <div class="modal fade" id="removeKnittingModal" tabindex="-1" aria-hidden="true">
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(URL::asset('build/js/pages/knittings/knittings-list.init.js')); ?>"></script>
...
<?php echo $__env->make('layouts.departments.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/owaisimam/PhpStormProjects/shafi_portal/resources/views/admin/department/knitting/index.blade.php ENDPATH**/ ?>