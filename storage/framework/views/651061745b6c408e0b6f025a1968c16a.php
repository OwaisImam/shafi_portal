...
<!-- Modal -->
<div class="modal fade" id="newDepartmentModal" tabindex="-1" aria-labelledby="newContactModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form autocomplete="off" method="POST" class="needs-validation createDepartment-form"
                    ...
                    action="<?php echo e(route('admin.departments.store')); ?>"
                    novalidate>
                    <?php echo csrf_field(); ?>
                    <div class="row">
                        <div class="col-lg-12">
...
<script
    src="<?php echo e(URL::asset('build/js/pages/departments/departments-list.init.js')); ?>">
</script>
