                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="credit_days" placeholder="Credit Days"
                                        value="<?php echo e(old('credit_days')); ?>" required name="credit_days">
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                    <div class="invalid-feedback">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="gst_no" placeholder="GST No"
                                        value="<?php echo e(old('gst_no')); ?>" required name="gst_no">
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                    <div class="invalid-feedback">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="required_delivery_date"
                                        placeholder="Required Delivery Date" value="<?php echo e(old('required_delivery_date')); ?>"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="ntn_no" placeholder="NTN No"
                                        value="<?php echo e(old('ntn_no')); ?>" required name="ntn_no">
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                    <div class="invalid-feedback">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="delivery_address"
                                        placeholder="Delivery Address" value="<?php echo e(old('delivery_address')); ?>" required
...
<?php echo $__env->make('layouts.departments.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/owaisimam/PhpStormProjects/shafi_portal/resources/views/admin/department/purchase_orders/create.blade.php ENDPATH**/ ?>