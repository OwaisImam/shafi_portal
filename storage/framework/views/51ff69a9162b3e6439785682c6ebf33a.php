...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'Slow Queries','title' => 'Time: '.e(number_format($time)).'ms; Run at: '.e($runAt).';','details' => ''.e(is_array($config['threshold']) ? '' : $config['threshold'].'ms threshold, ').'past '.e($this->periodForHumans()).'']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'pulse::components.icons.circle-stack','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'pulse::components.td','data' => ['class' => '!p-0 truncate max-w-[1px]']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php /**PATH /Users/owaisimam/PhpStormProjects/shafi_portal/vendor/laravel/pulse/src/../resources/views/livewire/slow-queries.blade.php ENDPATH**/ ?>