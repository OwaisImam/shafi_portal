                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="customer_po_number" value="<?php echo e(old('customer_po_number')); ?>"
                                        class="form-control">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="pyment_term_id" class="form-control select2">
                                        <option>Select</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="fabric_cosntruction_id" class="form-control select2">
                                        <option>Select</option>
                                    </select>
                                    <div class="valid-feedback">
                                        Looks good!
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="delivery_address" placeholder="GSM"
                        ...
                        <div data-repeater-list="group-a">
                            <div data-repeater-item class="row data-repeater-item">
                                <div class="mb-3 col-lg-2   ">
                                    ...
                                    <input type="text" id="article_style_no" name="article_style_no"
                                        class="form-control" placeholder="Enter Item Article No" />
                                </div>

                                <div class="mb-3 col-lg-2">
                                    <label for="uom">Title / Product Type</label>
                                    <select name="article_style_id" id="article_style_id" class="form-control select2">
                                        <option>Select</option>
                                ...
                                <div class="mb-3 col-lg-2">
                                    ...
                                    <input type="text" id="color" name="color" value="#556ee6"
