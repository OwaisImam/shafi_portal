                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-8">
                            <div class="text-sm-end">
                                <a href="<?php echo e(route('admin.email_templates.create')); ?>"
                                    class="btn btn-success btn-rounded waves-effect waves-light addContact-modal mb-2"><i
                                        class="mdi mdi-plus me-1"></i>New Email Template</a>
                            </div>
                        </div><!-- end col-->
                    </div>
                    <!-- end row -->
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(URL::asset('build/js/pages/email_templates/email_templates-list.init.js')); ?>"></script>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/owaisimam/PhpStormProjects/shafi_portal/resources/views/admin/email_template/index.blade.php ENDPATH**/ ?>