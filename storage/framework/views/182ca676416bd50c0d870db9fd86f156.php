...
<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('components.breadcrumb'); ?>
        ...
        <?php $__env->slot('title'); ?>
            <?php echo e($department->name); ?> Category
        <?php $__env->endSlot(); ?>
                        ...
                        <div class="col-sm-8">
                            <div class="text-sm-end">
                                <button type="button" data-bs-toggle="modal" data-bs-target="#newCategoryModal"
                                    class="btn btn-success btn-rounded waves-effect waves-light addCategory-modal mb-2"><i
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form autocomplete="off" method="POST" class="needs-validation createCategory-form"
                        enctype="multipart/form-data" id="createCategory-form"
                        action="<?php echo e(route('admin.departments.category.store', ['slug' => $department->slug])); ?>" novalidate>
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="col-lg-12">
                            ...
                            <div class="col-lg-12">
                                <div class="text-end">
                                    ...
                                    <button type="submit" id="addCategory-btn" class="btn btn-success">Add
                                        Category</button>
                                </div>
                            </div>
                        </div>
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(URL::asset('build/js/pages/category/categories-list.init.js')); ?>"></script>
...
<?php echo $__env->make('layouts.departments.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/owaisimam/PhpStormProjects/shafi_portal/resources/views/admin/department/category/index.blade.php ENDPATH**/ ?>