...
<?php echo app('translator')->get('translation.Counts'); ?>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-8">
                        <div class="text-sm-end">
                            <button type="button" data-bs-toggle="modal" data-bs-target="#newCountModal"
                                class="btn btn-success btn-rounded waves-effect waves-light addCount-modal mb-2"><i
                                    class="mdi mdi-plus me-1"></i> New Count</button>
                        </div>
                    </div><!-- end col-->
                </div>
                <!-- end row -->
...
<!-- Modal -->
<div class="modal fade" id="newCountModal" tabindex="-1" aria-labelledby="newCountModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="newCountModalLabel">Add Count</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form autocomplete="off" method="POST" class="needs-validation createCount-form"
                    enctype="multipart/form-data" id="createCount-form"
                    action="<?php echo e(route('admin.departments.count.store', ['slug' => $department->slug])); ?>"
                    novalidate>
                    <?php echo csrf_field(); ?>
                    <div class="row">
                        <div class="col-lg-12">
                            <input type="hidden" class="form-control" id="countId-input">
                            <div class="mb-3">
                        ...
                        <div class="col-lg-12">
                            <div class="text-end">
                                ...
                                <button type="submit" id="addCount-btn" class="btn btn-success">Add
                                    Count</button>
                            </div>
                        </div>
                    </div>
...
<!-- removeCountModal -->
<div class="modal fade" id="removeCountModal" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-content">
            <div class="modal-body px-4 py-5 text-center">
                ...
                <div class="hstack gap-2 justify-content-center mb-0">
                    <button type="button" class="btn btn-danger" id="remove-count">Remove Now</button>
...
<script
    src="<?php echo e(URL::asset('build/js/pages/counts/counts-list.init.js')); ?>">
</script>
...
<?php echo $__env->make('layouts.departments.master', Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/owaisimam/PhpStormProjects/shafi_portal/resources/views/admin/department/count/index.blade.php ENDPATH**/ ?>