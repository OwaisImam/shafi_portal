                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table mb-0">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $yarn_purchase_orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $yarn_purchase_order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><?php echo e($yarn_purchase_order->count->name . ' ' . $yarn_purchase_order->fiber->name); ?>

                                                <input type="hidden" name="yarn_purchase_order[<?php echo e($key); ?>][id]"
                                                    value="<?php echo e($yarn_purchase_order->id); ?>">

                                            </td>
                                            <td><?php echo e($yarn_purchase_order->unit); ?></td>
                                            <td>
                                                <div class="mb-3 col-lg-12">
                                                    <input type="number"
                                                        name="yarn_purchase_order[<?php echo e($key); ?>][qty]"
                                                        onchange="calculateTotalQty(this, <?php echo e($key); ?> )"
                                                        step="0.01" class="form-control qty"
                                                        value="<?php echo e($preProductionPlan->yarn_purchase_orders->where('yarn_purchase_order_id', $yarn_purchase_order->id)->first()?->qty); ?>"
                                                        max="<?php echo e($yarn_purchase_order->qty); ?>" required
                                                        placeholder="Enter qty">
                                                </div>
                                            </td>
                                            <td><span class="kgs_<?php echo e($key); ?> kgs">0</span>
                                                <input type="hidden" name="yarn_purchase_order[<?php echo e($key); ?>][kgs]"
                                                    required class="kgs_field_<?php echo e($key); ?>">
                                            </td>
                                            <td>
                                                <span class="percentage_<?php echo e($key); ?> percentage">0%</span>
                                                <input type="hidden"
                                                    name="yarn_purchase_order[<?php echo e($key); ?>][percentage]" required
                                                    class="percentage_field_<?php echo e($key); ?>">
                                            </td>
                                            <td>
                                                <span class="balance_<?php echo e($key); ?> balance">0</span>
                                                <input type="hidden"
                                                    name="yarn_purchase_order[<?php echo e($key); ?>][balance]" required
                                                    class="balance_field_<?php echo e($key); ?>">
                                            </td>
                                        </tr>
                                            ...
                                            <tbody class="process-list" id="processes">
                                                <?php $__currentLoopData = $processes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $process): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr class="align-middle" id="NewprocessForm<?php echo e($process->id); ?>">
                                                        ...
                                                        <td>
                                                            <div class="col-lg-12">
                                                                <div class="form-check form-check-primary">
                                                                    <input type="hidden"
                                                                        name="processes[<?php echo e($key); ?>][parent_process_id]"
                                                                        value="">
                                                                    <input class="form-check-input" type="checkbox"
                                                                        name="processes[<?php echo e($key); ?>][id]"
                                                                        value="<?php echo e($process->id); ?>"
                                                                        <?php echo e($preProductionPlan->processes->where('process_id', $process->id)->first() ? 'checked' : ''); ?>

                                                                        id="formCheckcolor<?php echo e($key); ?>">
                                                                    <label class="form-check-label"
                                                                        for="formCheckcolor<?php echo e($key); ?>">
                                                                        Yes
                                                                    </label>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <td>
                                                            <div class=" col-lg-12">
                                                                <input type="text" id="notes<?php echo e($key); ?>"
                                                                    name="processes[<?php echo e($key); ?>][notes]"
                                                                    value="<?php echo e($preProductionPlan->processes->where('process_id', $process->id)->first()?->notes); ?>"
                                                                    class="form-control" placeholder="Notes" />
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <?php if($process->is_default == 0): ?>
                                                                <a
                                                                    href="<?php echo e(route('admin.departments.processes.destroy', ['slug' => $department->slug, 'process' => $process->id])); ?>"><i
                                                    ...
                                                    <?php if($process->child->count() > 0): ?>
                                                        <?php $__currentLoopData = $process->child; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child_key => $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <tr class="align-middle"
                                                                ...
                                                                <td>
                                                                    <div class="col-lg-12">
                                                                        <div class="form-check form-check-primary">
                                                                            <input type="hidden"
                                                                                name="processes[<?php echo e($child_key . '' . $key); ?>][parent_process_id]"
                                                                                value="">
                                                                            <input class="form-check-input"
                                                                                type="checkbox"
                                                                                <?php echo e($preProductionPlan->processes->where('process_id', $child->id)->first() ? 'checked' : ''); ?>

                                                                                name="processes[<?php echo e($child_key . '' . $key); ?>][id]"
                                                                                value="<?php echo e($child->id); ?>"
                                                                                id="formCheckcolor<?php echo e($child_key . '' . $key); ?>">
                                                                            <label class="form-check-label"
                                                                                for="formCheckcolor<?php echo e($child_key . '' . $key); ?>">
                                                                                Yes
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <td>
                                                                    <div class=" col-lg-12">
                                                                        <input type="text"
                                                                            id="notes<?php echo e($child_key . '' . $key); ?>"
                                                                            name="processes[<?php echo e($child_key . '' . $key); ?>][notes]"
                                                                            class="form-control" placeholder="Notes" />
                                                                    </div>
                                                                </td>
                                                            </tr>
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $preProductionPlan->accessories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $accessories): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><input type="hidden" name="accessories[<?php echo e($key); ?>][item_id]"
                                                    value="<?php echo e($accessories->item_id); ?>"> <?php echo e($accessories->item->name); ?>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-check form-check-primary">
                                                        <input type="number" placeholder="Required Qty"
                                                            name="accessories[<?php echo e($key); ?>][qty]"
                                                            value="<?php echo e($accessories->qty); ?>" class="form-control">
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <textarea class="form-control" placeholder="Notes" name="accessories[<?php echo e($key); ?>][notes]"><?php echo e($accessories->notes); ?></textarea>
                                            </td>
                                            <td>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="col-lg-12">
                                <select class="form-select validate" id="ParentProcess">
                                    ...
                                    <?php $__currentLoopData = $processes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $process): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($process->id); ?>"><?php echo e($process->name); ?>
...
<?php echo $__env->make('layouts.departments.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/owaisimam/PhpStormProjects/shafi_portal/resources/views/admin/department/pre_production_plan/edit.blade.php ENDPATH**/ ?>