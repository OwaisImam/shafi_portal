...
<?php $__env->startSection('content'); ?>
    ...
    <form class="needs-validation" novalidate enctype="multipart/form-data" method="POST"
        action="<?php echo e(route('admin.departments.yarn_purchase_order.update', ['slug' => $department->slug, 'yarn_purchase_order' => $yarn_po->id])); ?>">
        <?php echo csrf_field(); ?>
                                    ...
                                    <select name="order_id" id="order_id" class="form-control select2" required>
                                        ...
                                        <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($order->id); ?>"
                                                <?php echo e($yarn_po->order_id == $order->id ? 'selected' : ''); ?>>
                                    ...
                                    <select name="job_id" id="job_id" class="form-control select2" required>
                                        ...
                                        <?php $__currentLoopData = $jobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($job->id); ?>"
                                                <?php echo e($yarn_po->job_id == $job->id ? 'selected' : ''); ?>><?php echo e($job->number); ?>
                                    ...
                                    <select name="count_id" id="count_id" class="form-control select2" required>
                                        ...
                                        <?php $__currentLoopData = $counts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($count->id); ?>"
                                                <?php echo e($yarn_po->count_id == $count->id ? 'selected' : ''); ?>>
                                    ...
                                    <select name="fiber_id" id="fiber_id" class="form-control select2" required>
                                        ...
                                        <?php $__currentLoopData = $fibers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fiber): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($fiber->id); ?>"
                                                <?php echo e($yarn_po->fiber_id == $fiber->id ? 'selected' : ''); ?>>
                                    ...
                                    <select name="fabric_construction_id" id="fabric_construction_id"
                                        ...
                                        <?php $__currentLoopData = $fabricConstructions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fabricConstruction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($fabricConstruction->id); ?>"
                                                <?php echo e($yarn_po->fabric_construction_id == $fabricConstruction->id ? 'selected' : ''); ?>>
                                    ...
                                    <select name="mill_id" id="mill_id"
                                        ...
                                        <?php $__currentLoopData = $mills; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($mill->id); ?>"
                                                <?php echo e($yarn_po->mill_id == $mill->id ? 'selected' : ''); ?>><?php echo e($mill->name); ?>
                                    ...
                                    <select name="agent_id" id="agent_id" class="form-control select2">
                                        ...
                                        <?php $__currentLoopData = $agents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($agent->id); ?>"
                                                <?php echo e($yarn_po->agent_id == $agent->id ? 'selected' : ''); ?>>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="terms_of_delivery_id" id="terms_of_delivery_id"
                                        ...
                                        <?php $__currentLoopData = $termsOfDelivery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $termsOfDeliver): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option
                                                value="<?php echo e($termsOfDeliver->id); ?>"<?php echo e($yarn_po->terms_of_delivery_id == $termsOfDeliver->id ? 'selected' : ''); ?>>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="number" name="contract_no"
                                        value="<?php echo e($yarn_po->contract_no); ?>" placeholder="Enter contract no" required
                                        id="contract_no">
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group" id="date_of_purchase_cont">
                                        <input type="text" class="form-control" placeholder="dd M, yyyy"
                                            value="<?php echo e($yarn_po->date_of_purchase ? $yarn_po->date_of_purchase : date('d M, Y')); ?>"
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group" id="delivery_date_cont">
                                        <input type="text" class="form-control" placeholder="dd M, yyyy"
                                            value="<?php echo e($yarn_po->delivery_date ? $yarn_po->delivery_date : date('d M, Y')); ?>"
                            ...
                            <div class="col-md-2">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" onkeyup="calculateKGsBags(this)"
                                        id="lbs" placeholder="Enter Lbs" value="<?php echo e($yarn_po->lbs); ?>" required
                                        name="lbs">
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                            ...
                            <div class="col-md-2">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="kgs" placeholder="Enter Kgs"
                                        value="<?php echo e($yarn_po->kgs); ?>" readonly required name="kgs">
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                    <div class="invalid-feedback">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="btn-group dropup">
                                        <input type="hidden" name="unit" id="unit"
                                            value="<?php echo e($yarn_po->unit); ?>">
                                        <input type="number" class="form-control" id="qty"
                                            placeholder="Enter Qty" value="<?php echo e($yarn_po->qty ?: old('qty')); ?>" readonly
                                            required name="qty">
                                        <button type="button" class="btn btn-primary dropdown-toggle" id="unitButton"
                                            data-bs-toggle="dropdown" aria-expanded="false">
                                            <?php echo e($yarn_po->unit); ?>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control" id="price_per_lb"
                                            ...
                                            value="<?php echo e($yarn_po->price_per_lb); ?>" required name="price_per_lb">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control" id="amount"
                                            placeholder="Enter amount" readonly value="<?php echo e($yarn_po->amount); ?>" required
                                            name="amount">
                                        <span class="input-group-text">Rs</span>
                                    </div>
                                    <div class="valid-feedback">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control" id="with_gst"
                                            placeholder="Enter amount with gst" readonly value="<?php echo e($yarn_po->with_gst); ?>"
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" id="completion_in"
                                            value="<?php echo e($yarn_po->completion_in ?: 0); ?>" name="completion_in"
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="number" placeholder="Enter balance" name="balance"
                                        class="form-control" id="balance" value="<?php echo e($yarn_po->balance); ?>" readonly
                                        required>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" name="invoice_of"
                                        value="<?php echo e($yarn_po->invoice_of ?: old('invoice_of')); ?>"
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <textarea type="number" placeholder="Enter remarks" name="remarks" class="form-control" id="remarks"><?php echo e($yarn_po->remarks); ?></textarea>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                    <div class="invalid-feedback">
...
<?php echo $__env->make('layouts.departments.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/owaisimam/PhpStormProjects/shafi_portal/resources/views/admin/department/yarn_purchase_order/edit.blade.php ENDPATH**/ ?>