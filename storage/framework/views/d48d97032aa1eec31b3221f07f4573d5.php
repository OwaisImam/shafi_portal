        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                ...
                <a href="index" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="<?php echo e(isset($settings->where('type', 'logo_light')->first()->value) ? App\Helper\Helper::getUploadedFile($settings->where('type', 'logo_light')->first()->value) : URL::asset('build/images/logo-light.svg')); ?>"
                            alt="" height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="<?php echo e(isset($settings->where('type', 'logo_light')->first()->value) ? App\Helper\Helper::getUploadedFile($settings->where('type', 'logo_light')->first()->value) : URL::asset('build/images/logo-light.png')); ?>"
                            alt="" height="19">
                    </span>
                </a>
            </div>
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    ...
                    <img class="rounded-circle header-profile-user"
                        src="<?php echo e(isset(Auth::guard('client')->user()->profilePicture) ? asset(Auth::guard('client')->user()->profilePicture->image_path) : asset('build/images/users/avatar-1.jpg')); ?>"
                        alt="Header Avatar">
                    <span class="d-none d-xl-inline-block ms-1"
                        key="t-henry"><?php echo e(ucfirst(Auth::guard('client')->user()->name)); ?></span>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" id="change-password">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" value="<?php echo e(Auth::guard('client')->user()->id); ?>" id="data_id">
                    <div class="mb-3">
...
unset($__errorArgs, $__bag); ?>" name="password"
                    ...
                    <div class="mt-3 d-grid">
                        <button class="btn btn-primary waves-effect waves-light UpdatePassword"
                            data-id="<?php echo e(Auth::guard('client')->user()->id); ?>" type="submit">Update Password</button>
                    </div>
                </form>
            </div>
        </div><!-- /.modal-content -->
...
<?php /**PATH /Users/owaisimam/PhpStormProjects/shafi_portal/resources/views/layouts/client/topbar.blade.php ENDPATH**/ ?>