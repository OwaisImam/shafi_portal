...
class Order extends Model
{
    ...
    protected $fillable = ['code', 'customer_po_number', 'customer_id', 'job_id', 'po_receive_date', 'delivery_date', 'payment_term_id', 'fabric_construction_id', 'gsm', 'order_quantity', 'article_style_count'];
