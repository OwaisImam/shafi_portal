                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="avatar-md profile-user-wid mb-4">
                                <img src="{{ isset($user->profilePicture) ? asset($user->profilePicture->image_path) : asset('build/images/users/avatar-1.jpg') }}"
                        ...
                        <table class="table table-nowrap mb-0">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $user->city?->state?->country?->name . ' ,' . $user->address }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <form class="form-horizontal" method="POST" enctype="multipart/form-data" id="update-profile">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="text-start mt-2">
                                <img src="{{ asset($user->profilePicture?->file_path) }}" alt=""
