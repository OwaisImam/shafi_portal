                        ...
                        @can('orders-create')
                            <div class="col-sm-8">
                                <div class="text-sm-end">
                                    <a href="{{ route('admin.departments.knitting_program.create', ['slug' => $department->slug]) }}"
...
@section('script')
    ...
    <script src="{{ URL::asset('build/js/pages/knitting_program/knitting_program-list.init.js') }}"></script>
