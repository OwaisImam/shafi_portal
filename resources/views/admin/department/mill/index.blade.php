            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form autocomplete="off" method="POST" class="needs-validation createMill-form"
                        ...
                        action="{{ route('admin.departments.mill.store', ['slug' => $department->slug]) }}" novalidate>
                        @csrf
                        <div class="row">
                            <div class="col-lg-12">
...
@section('script')
    ...
    <script src="{{ URL::asset('build/js/pages/mills/mills-list.init.js') }}"></script>
