            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form autocomplete="off" method="POST" class="needs-validation createKnitting-form"
                        ...
                        action="{{ route('admin.departments.knitting.store', ['slug' => $department->slug]) }}" novalidate>
                        @csrf
                        <div class="row">
                            <div class="col-lg-6">
...
@section('script')
    ...
    <script src="{{ URL::asset('build/js/pages/knittings/knittings-list.init.js') }}"></script>
