            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form autocomplete="off" method="POST" class="needs-validation createCategory-form"
                        ...
                        action="{{ route('admin.departments.category.store', ['slug' => $department->slug]) }}" novalidate>
                        @csrf
                        <div class="row">
                            <div class="col-lg-12">
...
@section('script')
    ...
    <script src="{{ URL::asset('build/js/pages/category/categories-list.init.js') }}"></script>
