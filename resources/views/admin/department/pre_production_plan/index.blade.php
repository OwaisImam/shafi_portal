                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-8">
                            <div class="text-sm-end">
                                <a href="{{ route('admin.departments.pre_production_plans.create', ['slug' => $department->slug]) }}"
...
@section('script')
    ...
    <script src="{{ URL::asset('build/js/pages/departments/departments-list.init.js') }}"></script>
