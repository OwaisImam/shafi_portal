                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <select class="select2 form-control" name="job_id" id="job-id-input"
                                        ...
                                        @foreach ($jobs as $job)
                                            <option value="{{ $job->id }}"
                                                {{ $slip->job_id == $job->id ? 'selected' : '' }}>{{ $job->number }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="slip_no" id="slip-input" value="{{ $slip->slip_no }}"
                                        ...
                                        <div class="col-lg-4">
                                            <select class="form-control select2" id="from-type-input"
                                                ...
                                                <option value="departments"
                                                    {{ $slip->delivery_from_type == 'departments' ? 'selected' : '' }}>
                                                    Department</option>
                                                <option value="knitting"
                                                    {{ $slip->delivery_from_type == 'knitting' ? 'selected' : '' }}>
                                                    Knitting House</option>
                                                <option value="dyeing"
                                                    {{ $slip->delivery_from_type == 'dyeing' ? 'selected' : '' }}>
                                                    Dyeing House</option>
                                            </select>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <select class="form-control select2" id="to-type-input"
                                                ...
                                                <option value="">Select</option>
                                                <option value="departments"
                                                    {{ $slip->delivery_to_type == 'departments' ? 'selected' : '' }}>
                                                    Department</option>
                                                <option value="knitting"
                                                    {{ $slip->delivery_to_type == 'knitting' ? 'selected' : '' }}>
                                                    Knitting House</option>
                                                <option value="dyeing"
                                                    {{ $slip->delivery_to_type == 'dyeing' ? 'selected' : '' }}>
                                                    Dyeing House</option>
                                            </select>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="driver_name" id="driver-name-input" class="form-control"
                                        placeholder="Enter driver name" value="{{ $slip->driver_name }}" required />
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="driver_cell_no" id="driver-cell-no-input"
                                        class="form-control" value="{{ $slip->driver_cell_no }}"
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="vehicle_no" id="vehicle-no-input" class="form-control"
                                        placeholder="Enter vehicle no" value="{{ $slip->vehicle_no }}" required />
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="vehicle_type" id="vehicle-type-input"
                                        class="form-control" value="{{ $slip->vehicle_type }}"
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="amount" id="amount-input" class="form-control"
                                        placeholder="Enter amount" value="{{ $slip->amount }}" required />
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="amount_in_words" id="amount-in-words-input"
                                        class="form-control" value="{{ $slip->amount_in_words }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <div>
                                        <input type="file" required name="attachment" id="attachment"
                                            class="form-control" />
                                        <a href="{{ $slip->attachment->image_path }}" class="mt-4" target="_blank">
                                            View Document</a>
    ...
    <script>
        ...
        $('#job-id-input').on('change', function(event) {
            ...
            @foreach ($slip->items as $item)
                var selectedOrders = [{{ $item->order_item->order_id }}];
            @endforeach
