                    ...
                    <div class="row">
                        <div class="col-7">
                            <div class="text-primary p-3">
                                ...
                                <p>{{ env('APP_NAME') }} {{ $department->name }} Dashboard</p>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="avatar-md profile-user-wid mb-4">
                                <img src="{{ isset(Auth::guard('web')->user()->avatar) ? asset(Auth::guard('web')->user()->avatar) : asset('build/images/users/avatar-1.jpg') }}"
                                    alt="" class="img-thumbnail rounded-circle">
                            </div>
                            <h5 class="font-size-15 text-truncate">{{ Str::ucfirst(Auth::guard('web')->user()->name) }}
                            </h5>
