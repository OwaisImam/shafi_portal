    ...
    $('#userList-table').DataTable({
        ...
        columns: [
            ...
            },
            {
                ...
                'bSortable': false,
                render: function (data, type, full) {
                    var hasEditPermission = datas.permissions.some(permission => permission.name === 'depart_yarn-yarn_purchase_order-edit');
                    var hasDeletePermission = datas.permissions.some(permission => permission.name === 'depart_yarn-yarn_purchase_order-delete');
